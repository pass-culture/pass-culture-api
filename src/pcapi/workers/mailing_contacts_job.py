...
@job_context
@log_job
def mailing_contacts_job(contact_email: str, contact_date_of_birth: str) -> None:
    _create_mailing_contact(contact_email, contact_date_of_birth)
    _add_contact_to_eligible_soon_list(contact_email)


def _create_mailing_contact(email: str, birth_date: str) -> None:
    ...
    response = mails.update_contact(email, birth_date=birth_date)
