...
class Subcategory:
    ...
    def __post_init__(self):
        if self.search_group not in [s.name for s in SearchGroupChoices]:
...
SUPPORT_PHYSIQUE_FILM = Subcategory(
    ...
    search_group=SearchGroupChoices.FILM.name,
    is_event=False,
    conditional_fields=[],
    can_expire=True,
    can_be_duo=False,
...
CARTE_CINE_MULTISEANCES = Subcategory(
    ...
    search_group=SearchGroupChoices.CINEMA.name,
    is_event=False,
    conditional_fields=[],
    can_expire=True,
    can_be_duo=False,
...
CONFERENCE = Subcategory(
    ...
    search_group=SearchGroupChoices.CONFERENCE.name,
    is_event=True,
...
CONCOURS = Subcategory(
    ...
    search_group=SearchGroupChoices.JEU.name,
    is_event=True,
    conditional_fields=[],
    can_expire=False,
    can_be_duo=True,
...
LIVRE_PAPIER = Subcategory(
    ...
    app_label="Livre",
    search_group=SearchGroupChoices.LIVRE.name,
    is_event=False,
...
CARTE_MUSEE = Subcategory(
    ...
    search_group=SearchGroupChoices.VISITE.name,
    is_event=False,
    conditional_fields=[],
    can_expire=True,
    can_be_duo=True,
...
CONCERT = Subcategory(
    ...
    pro_label="Concert",
    app_label="Concert",
    search_group=SearchGroupChoices.MUSIQUE.name,
    is_event=True,
...
SEANCE_ESSAI_PRATIQUE_ART = Subcategory(
    ...
    search_group=SearchGroupChoices.COURS.name,
    is_event=True,
    conditional_fields=["speaker"],
    can_expire=True,
    can_be_duo=True,
...
ABO_PRESSE_EN_LIGNE = Subcategory(
    ...
    search_group=SearchGroupChoices.PRESSE.name,
    is_event=False,
    conditional_fields=[],
    can_expire=False,
    can_be_duo=False,
...
SPECTACLE_REPRESENTATION = Subcategory(
    ...
    search_group=SearchGroupChoices.SPECTACLE.name,
    is_event=True,
...
ACHAT_INSTRUMENT = Subcategory(
    ...
    search_group=SearchGroupChoices.INSTRUMENT.name,
    is_event=False,
    conditional_fields=[],
    can_expire=True,
    can_be_duo=False,
...
MATERIEL_ART_CREATIF = Subcategory(
    ...
    search_group=SearchGroupChoices.MATERIEL.name,
    is_event=False,
    conditional_fields=[],
    can_expire=True,
    can_be_duo=False,
...
ACTIVATION_EVENT = Subcategory(
    ...
    search_group=SearchGroupChoices.NONE.name,
    is_event=True,
    conditional_fields=[],
    can_expire=False,
    can_be_duo=False,
...
SearchGroupChoicesEnum = Enum(
    ...
    {search_group_choice: search_group_choice for search_group_choice in [c.name for c in SearchGroupChoices]},
)
