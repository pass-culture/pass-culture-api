...
MAX_ID_CHECK_UNREAD_DOCUMENT_TRIAL_ATTEMPTS = int(os.environ.get("MAX_ID_CHECK_UNREAD_DOCUMENT_RETRY_ATTEMPTS", 2))
ID_CHECK_UNREAD_DOCUMENT_ATTEMPTS_TTL = int(os.environ.get("ID_CHECK_UNREAD_DOCUMENT_ATTEMPTS_TTL", 24 * 60 * 60))
