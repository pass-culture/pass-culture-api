...
def save_users_with_deposits():
    ...
    ApiHandler.save(deposit1, deposit2, deposit3, deposit4, deposit5)
...
def save_offerer_with_iban():
    ...
    ApiHandler.save(bank_information, venue_online, venue_with_siret, venue_without_siret)
...
def save_offerer_without_iban():
    ...
    ApiHandler.save(bank_information, venue_online, venue_with_siret_with_iban, venue_with_siret_without_iban)
...
def save_free_event_offer_with_stocks(venue: Venue):
    ...
    ApiHandler.save(past_free_event_stock, future_free_event_stock)
...
def save_non_reimbursable_thing_offer(venue: Venue):
    ...
    ApiHandler.save(non_reimbursable_stock)
...
def save_reimbursable_thing_offer(venue: Venue):
    ...
    ApiHandler.save(reimbursable_stock)
...
def save_paid_reimbursable_event_offer(venue: Venue):
    ...
    ApiHandler.save(past_event_stock, future_event_stock)
