...
class Get:
    ...
    class Returns200:
        ...
        def when_user_returns_types_labels(self, app):
            ...
            assert "Conférences, rencontres et découverte des métiers" in app_labels
            assert "Musée, arts visuels et patrimoine" in app_labels
            assert "Pratique artistique" in app_labels
            assert "Livre ou carte lecture" in app_labels
            assert "Livre audio numérique" in app_labels
