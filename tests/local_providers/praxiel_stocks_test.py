...
class PraxielStocksTest:
    ...
    class UpdateObjectsTest:
        ...
        def test_stock_provider_praxiel_create_one_stock_and_one_offer_with_wanted_attributes(
            ...
            # Given
            mock_praxiel_api_response.return_value = iter([{"ref": "9780199536986", "available": 10, "price": 16.5}])
            ...
            venue_provider = create_venue_provider(
                venue, praxiel_stocks_provider, is_active=True, venue_id_at_offer_provider="77567146400110"
            )
            product = create_product_with_thing_type(id_at_providers="9780199536986")
        ...
        def test_stock_provider_praxiel_update_one_stock_and_update_matching_offer(
            ...
            # Given
            mock_praxiel_api_response.return_value = iter([{"ref": "9780199536986", "available": 10, "price": 16}])
            ...
            praxiel_stocks_provider = activate_provider("PraxielStocks")
            venue_provider = create_venue_provider(
                venue, praxiel_stocks_provider, is_active=True, venue_id_at_offer_provider="12345678912345"
            )
            product = create_product_with_thing_type(id_at_providers="9780199536986")
        ...
        def test_praxiel_stocks_create_2_stocks_and_2_offers_even_if_existing_offer_on_same_product(
            ...
            offer = create_offer_with_thing_product(venue, product=product_2, id_at_providers="everything_but_praxiel")
        ...
        def test_stock_provider_praxiel_available_stock_is_sum_of_updated_available_and_bookings(
            ...
            # Given
            mock_praxiel_api_response.return_value = iter([{"ref": "9780199536986", "available": 5, "price": 0}])
            ...
            mock_praxiel_api_response.return_value = iter([{"ref": "9780199536986", "available": 66, "price": 0}])
