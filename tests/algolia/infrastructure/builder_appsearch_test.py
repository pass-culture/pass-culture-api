...
class BuildObjectTest:
    ...
    def test_should_return_algolia_object_with_required_information(self, app):
        ...
        # When
        result = build_appsearch_object(offer)

        # Then
        assert result == {
            "object_id": 3,
            "offer_author": None,
            "offer_category": "MUSIQUE",
            "offer_date_created": 1577872800.0,
            "offer_dates": [1603098000.0, 1603098000.0, 1603098000.0],
            "offer_description": "Un lit sous une rivière",
            "offer_withdrawal_details": "A emporter sur place",
            "offer_id": "AM",
            "offer_pk": 3,
            "offer_isbn": None,
            "offer_is_duo": 0,
            ...
            "offer_is_event": 1,
            "offer_is_thing": 0,
            "offer_label": "Concert ou festival",
            "offer_name": "Event name",
            "offer_music_sub_type": None,
            "offer_music_type": None,
            "offer_performer": None,
            "offer_prices": [Decimal("0.00"), Decimal("10.00"), Decimal("20.00")],
            "offer_price_min": Decimal("0.00"),
            "offer_price_max": Decimal("20.00"),
            "offer_show_sub_type": None,
            "offer_show_type": None,
            "offer_speaker": None,
            "offer_stage_director": None,
            "offer_stocks_date_created": [1606820400.0, 1607166000.0, 1607673600.0],
            "offer_thumb_url": f"http://localhost/storage/thumbs/products/{humanized_product_id}",
            "offer_tags": [],
            "offer_times": [32400],
            "offer_type": "Écouter",
            "offer_visa": None,
            ...
            "venue_city": "Paris",
            "venue_departement_code": "93",
            "venue_name": "Venue name",
            "venue_public_name": "Venue public name",
            "geolocation": "48.86387,2.33802",
        }
    ...
    def test_should_return_default_coordinates_when_one_coordinate_is_missing(self, app):
        ...
        # Then
        assert result["geolocation"] == "47.158459,2.409289"
