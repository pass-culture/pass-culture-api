...
class StockProviderLibrairesRepositoryTest:
    ...
    def should_instanciate_provider_api_with_correct_params(self):
        # Then
        assert (
            self.stock_provider_libraires_repository.libraires_api.api_url
            == "https://passculture.leslibraires.fr/stocks"
        )
    ...
    def should_call_provider_api_stocks_with_expected_arguments(self):
        # When
        self.stock_provider_libraires_repository.stocks_information(
            siret="12345678912345", last_processed_reference="9782070584628", modified_since=datetime(2019, 10, 1)
        )

        # Then
        self.stock_provider_libraires_repository.libraires_api.stocks.assert_called_once_with(
            siret="12345678912345", last_processed_reference="9782070584628", modified_since="2019-10-01T00:00:00Z"
        )

    def should_set_empty_modified_since_date_when_no_modified_since_date_given(self):
        # When
        self.stock_provider_libraires_repository.stocks_information(
            siret="12345678912345", last_processed_reference="9782070584628"
        )

        # Then
        self.stock_provider_libraires_repository.libraires_api.stocks.assert_called_once_with(
            siret="12345678912345", last_processed_reference="9782070584628", modified_since=""
        )
    ...
    def should_return_correct_stock_information_when_libraires_api_returns_two_stocks(self):
        ...
        self.stock_provider_libraires_repository.libraires_api.stocks.return_value = {
            ...
            "offset": 0,
            "stocks": [
                {"ref": "9780199536986", "available": 1, "price": 6.36},
                {"ref": "0000191524088", "available": 1, "price": 9.15},
            ],
        }
    ...
    def should_call_provider_api_siret_with_expected_siret(self):
        ...
        # Then
        self.stock_provider_libraires_repository.libraires_api.is_siret_registered.assert_called_once_with(
