...
from scripts.clean_activity import (
    delete_tables_from_activity,
...
class DeleteTablesFromActivityTest:
    ...
    @clean_database
    def test_should_not_delete_from_activity_when_table_name_is_not_in_provided_list(
        self, app
    ):
        # Given
        product_activity = create_activity("product", "insert")
...
class PopulateCulturalSurveyFilledDateFromActivityTest:
    ...
    @clean_database
    def test_does_not_fill_cultural_survey_filled_date_from_activity_when_user_id_does_not_match(
        self, app
    ):
        # Given
        user = create_user(idx=1, needs_to_fill_cultural_survey=False)
    ...
    @clean_database
    def test_does_fill_cultural_survey_filled_date_with_last_matching_activity_date(
        self, app
    ):
        # Given
