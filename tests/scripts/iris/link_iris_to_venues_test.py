...
class LinkIrisesToExistingPhysicalVenuesTest:
    ...
    def test_should_link_existing_eligible_venue_to_existing_iris(self, app):
        ...
        polygon = Polygon([(2.086668, 49.440898), (2.086668, 49.440902), (2.086672, 49.440902), (2.086672, 49.440898)])
    ...
    def test_should_look_for_irises_located_near_each_venue_to_link(
        self, insert_venue_in_iris_venue, find_ids_of_irises_located_near_venue, _find_all_venues_to_link, app
    ):
        # Given
    ...
    def test_should_link_each_venue_to_nearby_irises(
        self, insert_venue_in_iris_venue, find_ids_of_irises_located_near_venue, _find_all_venues_to_link, app
    ):
        # Given
        number_of_venues_to_link = 5
...
class FindAllVenueIdsToLinkTest:
    ...
    def test_should_not_return_ids_of_virtual_venues(self, app):
        ...
        offerer = create_offerer()
        venue = create_venue(
            offerer, is_virtual=True, address=None, departement_code=None, postal_code=None, siret=None
        )
