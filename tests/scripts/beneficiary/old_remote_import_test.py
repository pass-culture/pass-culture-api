...
from tests.scripts.beneficiary.old_remote_fixture import APPLICATION_DETAIL_STANDARD_RESPONSE
from tests.scripts.beneficiary.old_remote_fixture import make_old_application_detail
...
class OldRemoteImportRunTest:
    ...
    @patch("pcapi.settings.DEMARCHES_SIMPLIFIEES_OLD_ENROLLMENT_PROCEDURE_ID", 2567158)
...
class ProcessBeneficiaryApplicationTest:
    ...
    def test_new_beneficiaries_are_recorded_with_deposit(self, app):
        ...
        # when
        old_remote_import.process_beneficiary_application(
