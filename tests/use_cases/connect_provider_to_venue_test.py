...
from local_providers import AllocineStocks, FnacStocks, LibrairesStocks, TiteLiveStocks, PraxielStocks
    ...
    class ConnectProviderToVenueTest:
        ...
        class WhenProviderIsLibraires:
            ...
            def should_not_connect_venue_when_venue_has_no_siret(self, app):
                ...
                # then
                assert error.value.errors['provider'] == [
                    'L’importation d’offres avec LesLibraires n’est pas disponible sans SIRET associé au lieu. '
                    'Ajoutez un SIRET pour pouvoir importer les offres.']
        ...
        class WhenProviderIsFnac:
            ...
            def should_not_connect_venue_when_venue_has_no_siret(self, app):
                ...
                # then
                assert error.value.errors['provider'] == [
                    'L’importation d’offres avec FNAC n’est pas disponible sans SIRET associé au lieu. '
                    'Ajoutez un SIRET pour pouvoir importer les offres.']
        ...
        class WhenProviderIsPraxiel:
            ...
            def should_not_connect_venue_when_venue_has_no_siret(self, app):
                ...
                # then
                assert error.value.errors['provider'] == [
                    'L’importation d’offres avec Praxiel/Inférence n’est pas disponible sans SIRET associé au lieu.'
                    ' Ajoutez un SIRET pour pouvoir importer les offres.']
