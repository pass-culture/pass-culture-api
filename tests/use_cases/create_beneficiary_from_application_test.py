...
def test_saved_a_beneficiary_from_application(stubed_random_token, get_application_content, app):
    # Given
...
@freeze_time("2013-05-15 09:00:00")
@pytest.mark.usefixtures("db_session")
def test_application_for_native_app_user(get_application_content, app):
    # Given
...
@patch("pcapi.connectors.beneficiaries.jouve_backend.get_application_content")
@pytest.mark.usefixtures("db_session")
def test_cannot_save_beneficiary_if_email_is_already_taken(get_application_content, app):
    # Given
    email = "rennes@example.org"
...
@patch("pcapi.connectors.beneficiaries.jouve_backend.get_application_content")
@pytest.mark.usefixtures("db_session")
def test_cannot_save_beneficiary_if_duplicate(get_application_content, app):
    # Given
    first_name = "Thomas"
    last_name = "DURAND"
