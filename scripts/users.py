...
from repository.booking_queries import user_has_booked_an_online_activation, existing_token
...
def run(csv_file_path: str) -> None:
    ...
    logger.info('Users et Bookings créés ou mis à jour -> %s' % total)
